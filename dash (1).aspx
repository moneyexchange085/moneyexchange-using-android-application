<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dash.aspx.cs" Inherits="dash" %>
  ...
  <br/>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
          ...
          <asp:Button ID="Button1" runat="server" Text="Pay" BackColor="#00CCFF" Height="37px" Width="127px" OnClick="Button1_Click"  />  
        
         &nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button2" runat="server" Text="Receive" BackColor="#00CCFF" Height="37px" Width="127px" OnClick="Button2_Click"  />  
          <br />
